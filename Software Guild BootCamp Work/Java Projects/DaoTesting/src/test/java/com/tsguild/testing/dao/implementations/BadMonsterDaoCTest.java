...
public class BadMonsterDaoCTest {
    ...
    public void updateMonsterMethodTest() {
        ...
        Assert.assertNotSame("checking to make sure thst the updated Bob's humansEaten stat was changed", bob.getPeopleEaten(), retrivedNewBob.getPeopleEaten());
        Assert.assertNotSame("checking to make sure thst the updated Bob's humansEaten stat was changed", bob.getFavoriteFood(), retrivedNewBob.getFavoriteFood());
        ...
        Assert.assertNotSame("checking to make sure thst the updated Jeff's humansEaten stat was changed", jeff.getPeopleEaten(), retrivedNewJeff.getPeopleEaten());
