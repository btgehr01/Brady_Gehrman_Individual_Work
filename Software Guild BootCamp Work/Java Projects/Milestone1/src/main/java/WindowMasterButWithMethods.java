 ...
 * @author 19bgehrman
 */
public class WindowMasterButWithMethods {
    ...
    public static void main(String[] args) {
        ...
        WindowMasterButWithMethods.displayShopGreeting();
        ...
        do {
            ...
            System.out.println("Do you want to buy another window?! (y/n)");
    ...
    public static void displayShopGreeting() {
