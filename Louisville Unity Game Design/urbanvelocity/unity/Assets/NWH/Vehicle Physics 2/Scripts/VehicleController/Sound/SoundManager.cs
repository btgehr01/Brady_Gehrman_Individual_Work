...
namespace NWH.VehiclePhysics2.Sound
{
    ...
    public partial class SoundManager : VehicleComponent
    {
        ...
        /// <summary>
        /// Handles all the one shot sounds.
        /// </summary>
        [UnityEngine.Tooltip("Handles all the one shot sounds.")]
        ...
        public override void Initialize()
        {
            ...
            // Initialize AudioSource for one shot sounds
            oneShotAudioSource = otherSourceGO.AddComponent<AudioSource>();
            oneShotAudioSource.outputAudioMixerGroup = otherMixerGroup;
            oneShotAudioSource.volume = 1f;
            oneShotAudioSource.pitch = 1f;
            oneShotAudioSource.priority = 100;
            oneShotAudioSource.dopplerLevel = dopplerLevel;
            oneShotAudioSource.spatialBlend = spatialBlend;
            ...
            turboWhistleComponent.InitializeSoundComponent(engineMixerGroup, engineSourceGO);
            turboFlutterComponent.InitializeSoundComponent(engineMixerGroup, engineSourceGO);
            ...
            crashComponent.InitializeSoundComponent(crashMixerGroup, otherSourceGO);
