...
namespace NWH.VehiclePhysics2.Input
{
    ...
    public partial class VehicleInputHandler : VehicleComponent
    {
        ...
        /// </summary>
        [UnityEngine.Tooltip("    Should steering input be inverted?")]
        public bool invertSteering;

        /// <summary>
        ///     Should throttle input be inverted?
        /// </summary>
        [UnityEngine.Tooltip("    Should throttle input be inverted?")]
        public bool invertThrottle;

        /// <summary>
        ///     Should brake input be inverted?
        /// </summary>
        [UnityEngine.Tooltip("    Should brake input be inverted?")]
        public bool invertBrakes;

        /// <summary>
        ///     Should clutch input be inverted?
        /// </summary>
        [UnityEngine.Tooltip("    Should clutch input be inverted?")]
        public bool invertClutch;

        /// <summary>
        ///     Should handbrake input be inverted?
        /// </summary>
        [UnityEngine.Tooltip("    Should handbrake input be inverted?")]
